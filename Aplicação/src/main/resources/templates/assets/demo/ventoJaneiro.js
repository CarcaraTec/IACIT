...
for (var i = 0; i<arrayVento.length; i++){
    ...
    arrayHora.push(arrayVento[i].vento_data.slice(0, -19)+" "+arrayVento[i].vento_hora.slice(11, -13));
    if(arrayVento[i].vento_rajada_max==-999){
        arrayVentoRajada.push(null);
    }else{
        arrayVentoRajada.push(arrayVento[i].vento_rajada_max);
    }
...
myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointRadius: 3,
      pointBackgroundColor: "rgba(148,0,0,1))",
