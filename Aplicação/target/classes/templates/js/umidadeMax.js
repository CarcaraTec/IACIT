$(document).ready(function(){
    $.getJSON("/umidade_max",function(data){
                ...
                $(document).ready(function(){
                        ...
                        for(var i = 0;i<5;i++){
                            function nomeEstacao(nomear){
                                 ...
                                 $("#umiEstacao"+i+"Maior").prepend(esta.nome_estacao)
                                 $("#umidadeMin"+i+"Maior").prepend("Umidade Mínima: "+tempMin[i].umi_min+"%")
                                 $("#umidadeMax"+i+"Maior").prepend("Umidade Máxima: "+tempMin[i].umi_max+"%")
                                 $("#UmidadeMedia"+i+"Maior").prepend("Umidade Média: "+tempMin[i].umi_ar+"%")
                                 $("#umidadeData"+i+"Maior").prepend("DATA: "+prec_data.toLocaleDateString("pt-BR"))

                                const a = document.querySelector("#verDetalhesU"+i+"Maior");
